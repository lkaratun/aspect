...
#ifndef _aspect_postprocess_topography_to_file_h
#define _aspect_postprocess_topography_to_file_h
...
namespace aspect
{
  namespace Postprocess
  {
     ...
     */
    template <int dim>
    class TopographyToFile : public Interface<dim>, public ::aspect::SimulatorAccess<dim>
    {
      public:
        /**
